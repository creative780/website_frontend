  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/api/second-carousel/`,
        withFrontendKey({
          method: 'POST',
    ...
    <AdminAuthGuard>
      <div className="flex flex-col lg:flex-row min-h-screen bg-gray-50">
        ...
        <main className="flex-1 p-4 sm:p-6">
          ...
          {/* Title */}
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-1">Second Carousel Title</label>
            <input
              type="text"
          ...
          {/* Description */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-1">Second Carousel Description</label>
            <input
              type="text"
